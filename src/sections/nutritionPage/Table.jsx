...
function NutritionTable({ props }) {
  ...
  return (
    <>
        ...
        <div class="label">
            <header>
            <h1 class="bold">Nutrition Facts for 
            {(props.foodItem === "") ? (<em> <p> {String(" insert food item")} </p> </em>)
            : " " + props.foodItem}</h1>
            ...
            <p>
                ...
                <div style = {{display: "inline"}}>
                    {props.totalFat !== 0 ? (
                    <p style = {{display: "inline"}}>{" " + props.totalFat.toFixed(2)}{props.totalFatUnit}</p>
                    ) : (
            ...
            <p>
                ...
                <div style = {{display: "inline"}}>
                    {props.totalCarbs !== 0 ? (
                    <p style = {{display: "inline"}}>{" " + props.totalCarbs.toFixed(2)}{props.totalCarbsUnit}</p>
                    ) : (
                    <p style = {{display: "inline"}}> 0{props.totalCarbsUnit}</p>
                    )}
                </div>
                </span>{" "}
                <span class="bold">
            ...
            <p>
                <span>
                    ...
                    <div style = {{display: "inline"}}>
                        ...
                        <p style = {{display: "inline"}}>{" " + props.totalProtein.toFixed(2)}{props.totalProteinUnit}</p>
                        ) : (
                        <p style = {{display: "inline"}}> 0{props.totalProteinUnit}</p>
                        )}
                    </div>
                </span>{" "}
                <span class="bold">
