      ...
      <OneWorkoutContainer>
        ...
        <ExercisesAndToggleContainer>
          <div>
            ...
            <NormalTextStyle>
              {"Bench Press, Bicep Curls, Lateral Raises, Squats"}
            </NormalTextStyle>
          </div>
        ...
        <VolumeAndPRContainer>
          <FlexBoxAndRow>
            ...
            <BoldedText>Total Volume:&nbsp;</BoldedText>
            <NormalTextStyle>{7600} lbs</NormalTextStyle>
          </FlexBoxAndRow>
          <FlexBoxAndRow>
            {/* REPLACE WITH NUMBER OF PRs */}
            <BoldedText>Number of PRs:&nbsp;</BoldedText>{" "}
            <NormalTextStyle>{2}</NormalTextStyle>
          </FlexBoxAndRow>
        </VolumeAndPRContainer>
        {showAddInfo && (
